...
Quiero que no sean muy geométricas ni muy neon. Siento que asi se ven muy estilo básico p5. La idea es que sean formas irregulares y que los colores cambien con el audio. 

¿Qué paleta de colores usarás y por qué?

Quiero colores diferentes al rojo, azul, verde básicos de p5. Trataré de usar colores con transparencias y una paleta con morados y naranjas.

¿Cómo reaccionarán las visuales al audio? (¿Qué parámetros del audio controlarán qué aspectos visuales?)

La idea es que se las visuales reaccionen al audio pero tambien lo modifiquen. Quiero que hayan varios elementos que se puedan mover para cambiar instrumentos independientes, y eso cambie el color o tamaños/intensidades de los elementos. Parametros como velocidad, volumen, y octava es lo que se podr[a modificar.

¿Por qué estas decisiones estéticas sirven al concepto de tu obra?

Porque hacen que el strudel sea modificable por el usuario en tiempo real y pueda explorar combinaciones.
...
Me gusta el resultado logrado. Funciona para la idea original y las visuales reaccionan al audio en vivo mientras cambia.

Los principales desafios fueron lograr que el strudel y el p5 estuvieran conectados de ida y vuelta. Mandar solo las señales de strudel para visuales es sencillo, pero que el p5 envie señales que cambien el audio añade otros pasos. Consultando con IA me recomendó usar señales MIDI para esto. Resolví usando el programa loopMidi y ajustando el bridge para las conexiones necesarias. El strudel se adaptó para esto también. Despues de mucho tratar, logré un resultado que me deja satisfecho, pero si se pueden pulir y cambiar algunas cosas como el fondo y como cambia. 
